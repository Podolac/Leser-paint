...
public class Cerc extends Figura{
    ...
    public Cerc(int x, int y, int r, Color c, boolean u, boolean s) {
        super(x,y,c,u,s);
        this.r = r;
    }
    ...
    @Override
    void deseneaza() {
        Interfata.gr.drawOval(x - r, y - r, 2 * r, 2 * r);
        if(u){Interfata.gr.fillOval(x - r, y - r, 2 * r, 2 * r);}
    }
    ...
    Cerc(DataInputStream dis) throws IOException{
        super(dis);
    ...
    Cerc(ArrayList<Integer> numere) throws IOException{
        super(numere);
        r=numere.remove(0);
    ...
    Cerc(DataInputStream dis, boolean citeste) throws IOException{
        super(dis, false);
        r=dis.readInt();
    }

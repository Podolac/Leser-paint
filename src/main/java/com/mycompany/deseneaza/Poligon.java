...
public class Poligon extends Figura{
    ...
    Poligon(int xm, int ym, Color c, boolean u, boolean s){
    ...
    Poligon(DataInputStream dis) throws IOException{
        super(dis);
    ...
    Poligon(ArrayList<Integer> numere) throws IOException{
        super(numere);
    ...
    Poligon(DataInputStream dis, boolean citeste) throws IOException{
        super(dis, false);
        int n=dis.readInt();
        puncte=new ArrayList();
        for(int i=0; i < n; i++){
